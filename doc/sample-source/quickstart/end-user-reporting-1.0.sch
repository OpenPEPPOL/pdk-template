...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding='xslt2' schemaVersion="ISO19757-3">
  ...
  <pattern id="default">
    ...
    <rule context="/eusr:EndUserStatisticsReport">
      ...
      see="sb://eusr:EndUserStatisticsReport/eusr:CustomizationID"
      ><warn>[SCH-EUSR-01] The customization ID MUST use the value 'urn:fdc:peppol.eu:edec:trns:end-user-statistics-report:1.0'</warn>
      </assert>
