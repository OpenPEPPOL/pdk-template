...
Ensure all the link:#_installation[installation] steps are applied, and open terminal run the `pdk` command, the output should be a below.

image::img/pkd_output.png[align="center"]


Now we can serve our static webpage, running the `pdk serve` command.
